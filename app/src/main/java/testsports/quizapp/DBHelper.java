...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String[] quest= {"How long is a marathon?", " How many players are there on a baseball team?","Which country won the World Cup 2018?",
                "What sport is played with this ball?", "What sport is played with this ball?", "What sport is played with this ball?",
                "Which swimming style is not allowed in the Olympics?", "For which team did Michael Jordan spend most of his career playing?","What sport is played with this ball? ","What sport is played with this ball?",
                "Which country has the most Olympic gold medals in swimming?","When was water polo created?"};

        String[] answ1= {"56.5 kilometres","5","Russia","Racquetball","Cricket","Polo","Dog paddle","Washington Wizards","Pool","Bowling","China","20th century"};
        String[] answ2= {"42.195 kilometres","8","France","TagPro","Golf","Rugby","Backstroke","Chicago Bulls","Snooker","Table tennis","USA","19th century"};
        String[] answ3= {"36.850 kilometres","11","Argentina","Stickball","Baseball","Lacrosse","Freestyle","Indiana Pacers","Water polo","Croquet","UK","18th century"};
        String[] answ4= {"25 kilometres","9","Croatia","Tennis","Tennis","Dodgeball","Butterfly","Atlanta Hawks","Lacrosse","Kickball","Australia","17th century"};
        String[] right_answer= {"42.195 kilometres","9","France","Tennis","Baseball","Lacrosse","Dog paddle","Chicago Bulls","Pool","Croquet","USA","19th century"};
